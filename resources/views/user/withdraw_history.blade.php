                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                        <p class="mb-0 badge badge-pill badge-soft-success font-size-11">{{$hi->address_name }}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 badge badge-pill badge-soft-info font-size-11">{{$hi->address }}</p>
                                    </td>
